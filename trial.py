...
users = {
    ...
    "ramesh_s":{"password": "Ramesh@TL#26", "name": "Ramesh Subhramani"}
...
def base_analysis(maple_df, cashify_df, spoc_df, lob_sales_df):
    ...
    if selected_month == "All":
        ...
        attach_df["Overall Sale"] = attach_df["Mobile Phone Sales"] + attach_df["Laptop Sales"] # alias for clarity
